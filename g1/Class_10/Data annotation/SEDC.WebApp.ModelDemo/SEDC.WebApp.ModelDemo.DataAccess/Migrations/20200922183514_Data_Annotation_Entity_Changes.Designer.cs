...
namespace SEDC.WebApp.ModelDemo.DataAccess.Migrations
{
    ...
    [Migration("20200922183514_Data_Annotation_Entity_Changes")]
    partial class Data_Annotation_Entity_Changes
    {
            ...
            modelBuilder.Entity("SEDC.WebApp.ModelDemo.DataAccess.Domain.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Delivered = false, PizzaId = 1, UserId = 1 },
                        new { Id = 2, Delivered = false, PizzaId = 11, UserId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("SEDC.WebApp.ModelDemo.DataAccess.Domain.Models.Order", b =>
                {
                    b.HasOne("SEDC.WebApp.ModelDemo.DataAccess.Domain.Models.Pizza", "Pizza")
                        .WithOne("Order")
                        .HasForeignKey("SEDC.WebApp.ModelDemo.DataAccess.Domain.Models.Order", "PizzaId")
